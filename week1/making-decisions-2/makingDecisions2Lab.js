...
// Do not edit the code below.
var nums = [1,2,3,6,22,98,45,23,22,12, -2];
let evensArr = []
// Do not edit the code above.
...
if (myFavoriteNumbers.length < 7) {
  console.log("There are not enough elements in this arry")
} else { //if (myFavoriteNumbers.length >= 7) {
  someNum = myFavoriteNumbers[6]
  //or someNum.push(myFavoriteNumbers[6])
}
console.log(someNum)
...
for (let i = 0; i <= 100; i++) {
  let a = (i % 15 === 0)
  switch(i) {
    case a: console.log("Devmountain")
    break;
    case (i % 5 === 0): console.log("mountain")
    break;
    case (i % 3 === 0): console.log("Dev")
    break;
