...
console.log(faveSnack + " & " + faveDrink)
console.log(private)
...
console.log("Netflix Subscription = $" + netflix)
console.log("Hulu Subscription = $" + hulu)
console.log("Disney+ Subscription = $" + disney)
console.log("YouTube Premium Subscription = $" + youtubePremium)
console.log("Peacock Subscription = $" + peacock)
...
console.log("Your Total Subscription cost is $", + total)
...
if (hulu === 0) {
    console.log("Hulu Canceled")
}
console.log("Peacock Subscription is now = $" + peacock)
console.log("Netflix Subcription is now $" + netflix)

huluSave = 7
peacockSave = 5
netflixSave = 7
console.log("You have saved $" + huluSave + peacockSave + netflixSave)
...
console.log("Your savings is " + savings + "%")
